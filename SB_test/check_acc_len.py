...
if __name__ == "__main__":
    log_file_path = "/Users/yijingyang/Library/CloudStorage/OneDrive-个人/GradPilot/ProgramDB/SB_test/train_efficient_bs128_roll4.log"
    # Example: analyze only first 100 steps (or use None for all steps)
    analyze_output_log(log_file_path, prompts_per_step=128, responses_per_prompt=4, max_steps=200)